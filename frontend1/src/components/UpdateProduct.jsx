...
const UpdateProduct = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    formData.append("imageFile", imageChanged && image ? image : null);
    formData.append(
      "product",
  ...
  const handleChange = (e) => {
    ...
    // Convert date input from yyyy-MM-dd to dd-MM-yyyy for backend
    const processedValue = name === 'releaseDate' ? formatDateForBackend(value) : value;
              ...
              <form className="row g-3" noValidate validated={validated.toString()} onSubmit={handleSubmit}>
                ...
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    value={formatDateForInput(updateProduct.releaseDate)}
                    name="releaseDate"
                    onChange={handleChange}
                    id="releaseDate"
                    required
